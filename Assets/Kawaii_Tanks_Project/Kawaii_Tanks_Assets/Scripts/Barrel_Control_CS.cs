...
namespace ChobiAssets.KTP
{
	...
	public class Barrel_Control_CS : MonoBehaviour
	{
		...
		[ Tooltip ("Time it takes to push back the barrel. (Sec)")] public float recoilTime = 0.05f;
		[ Tooltip ("Time it takes to to return the barrel. (Sec)")] public float returnTime = 0.05f;
